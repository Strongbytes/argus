...
emit once on exit. :class:`~argus.exporters.file.FileSpanExporter` writes each
trace to disk twice -- canonical OTLP/JSON and a human-readable rendering;
:class:`~argus.exporters.otlp.OTLPSpanExporter` POSTs the
